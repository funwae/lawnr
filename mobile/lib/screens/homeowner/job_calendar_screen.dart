...
class HomeownerJobCalendarScreen extends StatefulWidget {
  const HomeownerJobCalendarScreen({super.key});

  @override
  State<HomeownerJobCalendarScreen> createState() =>
      _HomeownerJobCalendarScreenState();
}

class _HomeownerJobCalendarScreenState
    extends State<HomeownerJobCalendarScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('My Jobs Calendar'),
